...
if ps -aux | grep "[o]verviewer.py" >/dev/null
    then
        ...
        ~/veradalelabs/Projects/overviewer_source/Minecraft-Overviewer/overviewer.py --config=/home/prozach/veradalelabs/Projects/overviewer_cfg/overviewer_dyn_offline.cfg --genpoi
        ~/veradalelabs/Projects/overviewer_source/Minecraft-Overviewer/overviewer.py --config=/home/prozach/veradalelabs/Projects/overviewer_cfg/overviewer_dyn_offline.cfg
fi
